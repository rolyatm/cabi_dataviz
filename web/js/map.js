...
var map = new L.Map("map", {
  ...
  maxZoom: 14, 
  minZoom: 12,
  attribution: 'Directions courtesy of <a href="http://www.mapquest.com/" target="_blank">MapQuest</a>',
  attribution: '2012 ride data provided by <a href="http://www.capitalbikeshare.com/" target="_blank">Capital Bikeshare</a> '
})
  ...
  var sfeature = gStations.selectAll("circle")
    ...
    sfeature.on("mousedown",function(d){
      ...
      if (d3.event.shiftKey) {
        ...
        d3.select("#origin").html("Station: " + d.properties.ADDRESS); 		
